...
use App\Database;
use App\Model\Cart\Model as CartModel;
use App\Model\CartItem\Model as CartItemModel;
use App\Model\CartItem\Collection as CartItemCollection;
use App\Model\Shipping\Model as ShippingModel;
use App\View\Cart as CartView;
...
class Cart
{
    public function indexAction()
    {
        ...
        $itemCollection = new CartItemCollection();
    ...
    public function handlerAction()
    {
        ...
        if (!$cartId) {
            ...
            $cartModel = new \App\Model\Cart\Model();
        ...
        switch ($action) {
            case 'add':
                ...
                // Stock check
                // Need Product Model
                $productModel = new \App\Model\Product\Model();
