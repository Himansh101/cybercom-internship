    ...
    <form id="profile-form" class="profile-form">
        ...
        <div class="profile-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($profile['name']); ?>" minlength="3" pattern="[a-zA-Z\s]+" required>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="mobile" name="mobile" value="<?php echo htmlspecialchars($profile['mobile'] ?? ''); ?>" pattern="(\+91)[6-9][0-9]{9}" placeholder="+919876543210">
        ...
        <div class="profile-section">
            ...
            <div class="form-group">
                ...
                <textarea id="street_address" name="street_address" rows="2" placeholder="House No, Street, Locality"><?php echo htmlspecialchars($profile['street_address'] ?? ''); ?></textarea>
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label for="city">City</label>
                    <input type="text" id="city" name="city" value="<?php echo htmlspecialchars($profile['city'] ?? ''); ?>" placeholder="Mumbai">
                </div>
                <div class="form-group">
                    <label for="pincode">Pincode</label>
                    <input type="text" id="pincode" name="pincode" value="<?php echo htmlspecialchars($profile['pincode'] ?? ''); ?>" pattern="[1-9][0-9]{5}" placeholder="400001">
        ...
        <div class="profile-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="new_password" name="new_password" minlength="8" placeholder="Min 8 characters">
